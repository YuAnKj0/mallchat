...
import com.yuankj.mallchat.user.domain.enums.ApplyStatusEnum;
import com.yuankj.mallchat.user.domain.enums.ApplyTypeEnum;
import com.yuankj.mallchat.user.mapper.UserApplyMapper;
import org.springframework.stereotype.Service;

import java.util.List;

import static com.yuankj.mallchat.user.domain.enums.ApplyReadStatusEnum.READ;
import static com.yuankj.mallchat.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.yuankj.mallchat.user.domain.enums.ApplyStatusEnum.AGREE;

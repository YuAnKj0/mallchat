...
import com.yuankj.mallchat.common.domain.dto.LoginMessageDTO;
import com.yuankj.mallchat.common.domain.dto.ScanSuccessMessageDTO;
...
/**
 * @author Ykj
 * @date 2024-02-29/10:57
 * @apiNote  处理与微信api的交互逻辑
 */
@Service
@Slf4j
public class WxMsgService {
	...
	public WxMpXmlOutMessage scan(WxMpService wxMpService, WxMpXmlMessage wxMpXmlMessage){
		...
		Integer loginCode = Integer.valueOf(getEventKey(wxMpXmlMessage));
		...
		mqProducer.sendMsg(MQConstant.SEND_MSG_TOPIC,new ScanSuccessMessageDTO(loginCode));

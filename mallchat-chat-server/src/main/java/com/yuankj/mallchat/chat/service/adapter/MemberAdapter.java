...
import static com.yuankj.mallchat.chat.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_ADD;
import static com.yuankj.mallchat.chat.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_REMOVE;

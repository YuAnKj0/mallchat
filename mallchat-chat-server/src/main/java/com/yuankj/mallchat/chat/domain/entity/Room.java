package com.yuankj.mallchat.chat.domain.entity;
...
public class Room implements Serializable {
     ...
     * 房间类型 1群聊 2单聊
     *
     * @see com.yuankj.mallchat.chat.domain.enums.RoomTypeEnum
     */
    @TableField("type")
     ...
     * 是否全员展示 0否 1是
     *
     * @see com.yuankj.mallchat.chat.domain.enums.HotFlagEnum
     */
    @TableField("hot_flag")
